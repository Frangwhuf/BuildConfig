...
OCScope::MapVariableDefinition OCScope::_null_map_def;

OCScope::ScopeStack OCScope::_scope_stack;

////////////////////////////////////////////////////////////////////
//     Function: OCScope::Constructor
//       Access: Public
//  Description: 
////////////////////////////////////////////////////////////////////
OCScope::
OCScope(OCNamedScopes *named_scopes) : 
  _named_scopes(named_scopes)
{
  _directory = (OCDirectory *)NULL;
  _parent_scope = (OCScope *)NULL;
}

////////////////////////////////////////////////////////////////////
//     Function: OCScope::get_named_scopes
//       Access: Public
//  Description: Returns a pointer to the OCNamedScopes collection
//               associated with this scope.  This pointer could be
//               NULL.
////////////////////////////////////////////////////////////////////
OCNamedScopes *OCScope::
get_named_scopes() {
  return _named_scopes;
}

////////////////////////////////////////////////////////////////////
//     Function: OCScope::set_parent
//       Access: Public
...
////////////////////////////////////////////////////////////////////
void OCScope::
set_parent(OCScope *parent) {
  _parent_scope = parent;
  define_variable("PARENTSCOPENAME", _named_scopes->get_scope_name(parent));
}

////////////////////////////////////////////////////////////////////
//     Function: OCScope::get_parent
//       Access: Public
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::define_variable
//       Access: Public
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::define_map_variable
//       Access: Public
...
define_map_variable(const string &varname, const string &key_varname,
  ...
  if (_named_scopes == (OCNamedScopes *)NULL) {
    return;
  }
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::add_to_map_variable
//       Access: Public
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::define_formals
//       Access: Public
...
get_variable(const string &varname) {
  ...
  const OCSubroutine *sub = OCSubroutine::get_func(varname);
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::expand_defined
//       Access: Private
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::expand_variable
//       Access: Public
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::find_map_variable
//       Access: Public
...
//               not.
////////////////////////////////////////////////////////////////////
OCScope::MapVariableDefinition &OCScope::
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::get_directory
//       Access: Public
...
OCDirectory *OCScope::
get_directory() {
  if (_directory != (OCDirectory *)NULL) {
    return _directory;
  }
  ...
  ScopeStack::reverse_iterator si;
  for (si = _scope_stack.rbegin(); si != _scope_stack.rend(); ++si) {
    if ((*si)->_directory != (OCDirectory *)NULL) {
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::set_directory
//       Access: Public
...
////////////////////////////////////////////////////////////////////
void OCScope::
set_directory(OCDirectory *directory) {
  _directory = directory;
}

////////////////////////////////////////////////////////////////////
//     Function: OCScope::expand_string
//       Access: Public
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::expand_self_reference
//       Access: Public
...
expand_self_reference(const string &str, const string &varname) {
  ...
  string reference;
  reference.reserve( varname.length() + 4 );
...
////////////////////////////////////////////////////////////////////
void OCScope::
push_scope(OCScope *scope) {
  _scope_stack.push_back(scope);
}

////////////////////////////////////////////////////////////////////
//     Function: OCScope::pop_scope
//       Access: Public, Static
...
pop_scope() {
  ...
  OCScope *back = _scope_stack.back();
  _scope_stack.pop_back();
  return back;
}

////////////////////////////////////////////////////////////////////
//     Function: OCScope::get_bottom_scope
//       Access: Public, Static
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::get_enclosing_scope
//       Access: Public, Static
...
////////////////////////////////////////////////////////////////////
OCScope *OCScope::
get_enclosing_scope(unsigned int n) {
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::tokenize_params
//       Access: Public
...
tokenize_params(const string &str, vector<string> &tokens,
  ...
  while (p < strLength ) {
    ...
    while (p < strLength && isspace(str[p])) {
      p++;
    }

    string token;
    token.reserve( strLength );

    while (p < strLength && str[p] != FUNCTION_PARAMETER_SEPARATOR) {
      if (p + 1 < strLength && str[p] == VARIABLE_PREFIX &&
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::tokenize_numeric_pair
//       Access: Public
...
tokenize_numeric_pair(const string &str, double &a, double &b) {
  ...
  if (words.size() != 2) {
    cerr << "tokenize_numeric_pair:: " << words.size() << " parameters supplied when two were expected:\n"
         << str << "\n";
    return false;
  }
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::tokenize_ints
//       Access: Public
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::scan_to_whitespace
//       Access: Public
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::p_set_variable
//       Access: Private
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::p_get_variable
//       Access: Private
...
p_get_variable(const string &varname, string &result) {
  ...
  if (varname == "RELDIR" && 
      _directory != (OCDirectory *)NULL &&
      current_output_directory != (OCDirectory *)NULL) {
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::r_expand_string
//       Access: Private
...
////////////////////////////////////////////////////////////////////
string OCScope::
r_expand_string(const string &str, OCScope::ExpandedVariable *expanded) {
  string result;
  size_t strLength = str.length();
  ...
  static const string prefix = string( 1, VARIABLE_PREFIX ) + string( 1, VARIABLE_OPEN_BRACE );
  size_t q = 0;
  size_t oldQ = 0;
  while( true ) {
    q = str.find( prefix, q );
    ...
    if( q == string::npos ) {
      result += str.substr( oldQ, strLength - oldQ );
      break;
    }
    else {
      result += str.substr( oldQ, q - oldQ );
      result += r_expand_variable( str, q, expanded );
    }
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::r_scan_variable
//       Access: Private
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::r_expand_variable
//       Access: Private
...
r_expand_variable(const string &str, size_t &vp,
                  OCScope::ExpandedVariable *expanded) {
  string varname;
  size_t strLength = str.length();
  varname.reserve( strLength );
  ...
  // bracket.
  size_t p = vp + 2;
  while (p < strLength && str[p] != VARIABLE_CLOSE_BRACE) {
    if (p + 1 < strLength && str[p] == VARIABLE_PREFIX && 
        str[p + 1] == VARIABLE_OPEN_BRACE) {
      if (whitespace_at != 0) {
      ...
      if (open_nested_at == 0 && str[p] == VARIABLE_OPEN_NESTED) {
        open_nested_at = varname.length();
      }
      if (open_nested_at == 0 && whitespace_at == 0 && isspace(str[p])) {
        whitespace_at = varname.length();
      }
      varname += str[p];
      p++;
    }
  ...
  if (whitespace_at != 0) {
    ...
    // Is it a user-defined function?
    const OCSubroutine *sub = OCSubroutine::get_func(funcname);
    if (sub != (const OCSubroutine *)NULL) {
    ...
    } else if (funcname == "formap") {
      return expand_formap(params);
    } else if (funcname == "relpath") {
      return expand_relpath(params);
    }
  ...
  if (got_patsubst) {
    ...
    if (tokens.size() != 2) {
      ...
      OCFilenamePattern from(tokens[0]);
      OCFilenamePattern to(tokens[1]);
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::expand_variable_nested
//       Access: Private
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::expand_isfullpath
//       Access: Private
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::expand_osfilename
//       Access: Private
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::expand_unixfilename
//       Access: Private
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::expand_wildcard
//       Access: Private
...
expand_isdir(const string &params) {
  ...
  if (!filename.is_fully_qualified()) {
    filename = expand_variable("TOPDIR") + "/" + expand_variable("PATH") + "/" + results[0];
  }
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::expand_isfile
//       Access: Private
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::expand_libtest
//       Access: Private
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::expand_bintest
//       Access: Private
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::expand_standardize
//       Access: Private
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::expand_canonical
//       Access: Private
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::expand_length
//       Access: Private
...
expand_length(const string &params) {
  ...
  char buffer[32];
  sprintf(buffer, "%d", static_cast<int>(word.length()));
  string result = buffer;
  return result;
}  

////////////////////////////////////////////////////////////////////
//     Function: OCScope::expand_substr
//       Access: Private
...
expand_substr(const string &params) {
  ...
  string result = word.substr(static_cast<unsigned>(start - 1), static_cast<unsigned>(end - start + 1));
  return result;
}  

////////////////////////////////////////////////////////////////////
//     Function: OCScope::expand_dir
//       Access: Private
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::expand_notdir
//       Access: Private
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::expand_suffix
//       Access: Private
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::expand_basename
//       Access: Private
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::expand_makeguid
//       Access: Private
...
expand_makeguid(const string &params) {
  ...
  MD5Update(&context, reinterpret_cast<const unsigned char *>(expansion.data()),
            static_cast<unsigned>(expansion.size()));
  ...
  for (si = guid.begin(); si != guid.end(); ++si) {
    (*si) = static_cast<char>(toupper(*si));
  }
...
expand_word(const string &params) {
  ...
  return words[static_cast<unsigned>(index - 1)];
}

////////////////////////////////////////////////////////////////////
//     Function: OCScope::expand_wordlist
//       Access: Private
...
expand_words(const string &params) {
  ...
  char buffer[32];
  sprintf(buffer, "%d", static_cast<int>(words.size()));
  string result = buffer;
  return result;
}

////////////////////////////////////////////////////////////////////
//     Function: OCScope::expand_firstword
//       Access: Private
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::expand_patsubst
//       Access: Private
...
expand_patsubst(const string &params, bool separate_words) {
  ...
  typedef vector<OCFilenamePattern> Patterns;
  ...
  for (i = 0; i < tokens.size() - 1; i += 2) {
    ...
    // wildcard character.
    OCFilenamePattern to_pattern(tokens[i + 1]);
    if (!to_pattern.has_wildcard()) {
      to_pattern = OCFilenamePattern(expand_string(tokens[i + 1]));
    }
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::expand_filter
//       Access: Private
...
expand_filter(const string &params) {
  ...
  for (wi = words.begin(); wi != words.end(); ++wi) {
    ...
    vector<OCFilenamePattern>::const_iterator pi;
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::expand_filter_out
//       Access: Private
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::expand_findstrnig
//       Access: Private
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::expand_wordsubst
//       Access: Private
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::expand_split
//       Access: Private
//  Description: Expands the "split" function variable: splits the
//               variable in the second parameter into a space
//               seperated list.  Splitting happens on the first
//               parameter.
////////////////////////////////////////////////////////////////////
string OCScope::
expand_split(const string &params) {
  // Split the string up into tokens base on the spaces.
  vector<string> tokens;
  tokenize_params(params, tokens, true);

  if (tokens.size() != 2) {
    cerr << "split requires two parameters.\n";
    return string();
  }

  const string &sep = tokens[0];
  vector<string> words;
  tokenize(tokens[1], words, sep);
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::expand_unique
//       Access: Private
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::expand_matrix
//       Access: Private
...
expand_if(const string &params) {
  ...
  if (tokens.size() == 2) {
    string conditional = expand_string(tokens[0]);
    if (!conditional.empty()) {
      return expand_string(tokens[1]);
    } else {
      return "";
    }
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::expand_divide
//       Access: Private
//  Description: Expands the "/" function variable.  This operates
//               on integer numbers.
////////////////////////////////////////////////////////////////////
...
expand_divide(const string &params) {
  ...
  if (tokens.size() != 2) {
    cerr << "expand_divide:: " << tokens.size() << " parameters supplied when two were expected:\n"
         << params << "\n";
    return string();
  }
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::expand_modulo
//       Access: Private
//  Description: Expands the "%" function variable.  This operates
//               on integer numbers.
////////////////////////////////////////////////////////////////////
...
expand_modulo(const string &params) {
  ...
  if (tokens.size() != 2) {
    cerr << "expand_modulo:  " << tokens.size() << " parameters supplied when two were expected:\n"
         << params << "\n";
    return string();
  }
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::expand_upcase
//       Access: Private
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::expand_downcase
//       Access: Private
...
expand_downcase(const string &params) {
  ...
  string::iterator si;
  for (si = result.begin(); si != result.end(); ++si) {
    (*si) = static_cast<char>(tolower(*si));
  }
  return result;
}

////////////////////////////////////////////////////////////////////
//     Function: OCScope::expand_cdefine
//       Access: Private
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::expand_closure
//       Access: Private
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::expand_unmapped
//       Access: Private
//  Description: Expands the "closure" function variable.  This is a
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::expand_dependencies
//       Access: Private
...
expand_dependencies(const string &params) {
  ...
  OCDirectory *directory = get_directory();
  assert(directory != (OCDirectory *)NULL);

  vector<string> results;
  vector<string>::const_iterator fi;
  for (fi = filenames.begin(); fi != filenames.end(); ++fi) {
    OCDependableFile *file = directory->get_dependable_file(*fi, false);
    assert(file != (OCDependableFile *)NULL);

    vector<OCDependableFile *> files;
    file->get_complete_dependencies(files);

    vector<OCDependableFile *>::const_iterator dfi;
    for (dfi = files.begin(); dfi != files.end(); ++dfi) {
      OCDependableFile *df = (*dfi);
      string rel_filename =
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::expand_foreach
//       Access: Private
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::expand_forscopes
//       Access: Private
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::expand_formap
//       Access: Private
//  Description: Expands the "formap" function variable.  This
//               evaluates an expression once per key in a map
//               variable.
////////////////////////////////////////////////////////////////////
string OCScope::
expand_formap(const string &params) {
  // Split the string up into tokens based on the commas.
  vector<string> tokens;
  tokenize_params(params, tokens, false);
  ...
  // The first parameter is the space-separated list of map variable
  // names.  The second parameter is the expression to evaluate.
  vector<string> map_names;
  tokenize_whitespace(expand_string(tokens[0]), map_names);
  vector<string> results;

  // Now iterate over scopes in each map.
  vector<string>::const_iterator mi;
  for (mi = map_names.begin(); mi != map_names.end(); ++mi) {
    string const & mapvar = *mi;
    OCScope::MapVariableDefinition &def = find_map_variable(mapvar);
    if (&def == &_null_map_def) {
      cerr << "Undefined map variable: $[formap " << mapvar << " ... ]\n";
      return string();
    }
    MapVariableDefinition::const_iterator di;
    for (di = def.begin(); di != def.end(); ++di) {
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::expand_relpath
//       Access: Private
//  Description: Expands the "relpath" function variable.  This
//               returns a relative path from one directory to
//               another.
////////////////////////////////////////////////////////////////////
string OCScope::
expand_relpath(const string &params) {
  // Split the string up into tokens based on the commas.
  vector<string> tokens;
  tokenize_params(params, tokens, false);

  if (tokens.size() != 2) {
    cerr << "relpath requires two parameters.\n";
    return string();
  }

  string from = expand_string(tokens[0]);
  string to = expand_string(tokens[1]);

  string::iterator si = from.end();
  --si;
  if ((*si) == '/') {
    from.erase(si);
  }
  ...
  vector<string> to_parts;

  tokenize(from, from_parts, "/");
  tokenize(to, to_parts, "/");

  vector<string>::iterator from_iter;
  vector<string>::iterator to_iter;
  for(from_iter=from_parts.begin(), to_iter=to_parts.begin();
      (from_iter!=from_parts.end())&&(to_iter!=to_parts.end())&&((*from_iter)==(*to_iter));
      ++from_iter, ++to_iter);

  string result;
  bool first = true;
  for(; from_iter != from_parts.end(); ++from_iter) {
    if (!first) {
      result += '/';
    }
    result += "..";
  ...
  for(; to_iter != to_parts.end(); ++to_iter) {
    if (!first) {
      result += '/';
    }
    result += *to_iter;
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::expand_function
//       Access: Private
...
expand_function(const string &funcname, 
                const OCSubroutine *sub, const string &params) {
  OCScope::push_scope((OCScope *)this);
  OCScope nested_scope(_named_scopes);
  ...
  OCCommandFile command(&nested_scope);
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::expand_map_variable
//       Access: Private
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::r_expand_matrix
//       Access: Private
...
r_expand_matrix(vector<string> &results, const vector<vector<string> > &words,
  ...
  if (index >= (int)words.size()) {
    ...
    const vector<string> &w = words[static_cast<unsigned>(index)];
    vector<string>::const_iterator wi;
...
////////////////////////////////////////////////////////////////////
//     Function: OCScope::p_find_map_variable
//       Access: Private
...
glob_string(const string &str, vector<string> &results) {
  // The globbing is relative to TOPDIR/PATH, not necessarily the
  // current directory.
  string dirname = trim_blanks(expand_variable("TOPDIR") + "/" + expand_variable("PATH"));
